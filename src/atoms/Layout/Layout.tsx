...
const Layout = (
    ...
    const styleBorderItem = (index: number) => {
        if (column === 3 && (lenghtData === 9)) {
            if (index === 5) {
                return {
                    borderTopColor: colorBorder, borderBottomColor: colorBorder,
            ...
            if (index === 2) {
                return {
                    borderBottomColor: colorBorder, borderBottomWidth: widthBorder,
                    borderLeftColor: colorBorder, borderLeftWidth: widthBorder
                }
            }
            if ((index !== 4) && (index !== 1) && (index !== 2) && (index !== 5) && (index !== 6) && (index !== 7) && (index !== 8)) {
                return {
                    borderBottomColor: colorBorder, borderRightColor: colorBorder,
        ...
        if ((column === 2) && (lenghtData === 4)) {
            ...
            if ((index === 1)) {
                return {
                    borderLeftColor: colorBorder, borderBottomColor: colorBorder,
